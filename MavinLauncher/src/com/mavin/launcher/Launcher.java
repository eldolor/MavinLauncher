...
import com.mavin.launcher.DropTarget.DragObject;
...
public final class Launcher extends Activity
    ...
    private static final String TOOLBAR_ICON_METADATA_NAME = "com.launcher.launcher.toolbar_icon";
...
/*        if (v instanceof Advanceable) {
    ...
    public void onDestroy() {
        ...
        try
        {
            Method m = ValueAnimator.class.getDeclaredMethod("clearAllAnimations");
...
//        ComponentName activityName = searchManager.getGlobalSearchActivity();
    ...
    /* Cling related */
    private static final String PREFS_KEY = "com.mavin.launcher.prefs";
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    ...
                    SharedPreferences prefs =
                        getSharedPreferences("com.mavin.launcher.prefs", Context.MODE_PRIVATE);
